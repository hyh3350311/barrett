...
<div class="content">
    ...
    <div class="page_zygb">
        <span class="span_zygb_bt_page">职业干部</span>
        <ul class="ul_zygb_page">
            <li><a href="#">普法考试</a></li>
            <li><a href="#">两学一做</a></li>
            <li><a href="#">三严三实</a></li>
            <li><a href="#">国梦</a></li>
            ...
            <li><a href="#">文化建设</a></li>
            <li><a href="#">社会建设</a></li>
            <li><a href="#">生态文明建设</a></li>
            <li><a href="#">国情与形势任务</a></li>
        </ul>
    </div>

    <div class="weizhi"><span class="span_weizhi">答案库 > 普法考试</span></div>
    <!-- left -->
    <script language="javascript">
        function LoadClick6(clickControl, divShow) {
            ...
            document.getElementById(clickControl).className = 'on6';
    ...
    <div class="page_left">
        <div class="zxst_top">
            <ul class="ul_zxst">
                <li id="n01" class="on6"><a href="#" onmouseover='LoadClick6("n01", "divn01")'>最新试题</a></li>
                <li><img src="images/line1.jpg"/></li>
                <li id="n02"><a href="#" onmouseover='LoadClick6("n02", "divn02")'>热门试题</a></li>
                <li><img src="images/line1.jpg"/></li>
            </ul>
        </div>
        <!-- 1 -->
        <div class="zxst_nr" id="divn01">
            <div class="divNew">
            ...
            <ul class="ul_zxst_nr">
                ...
                <li><a href="#">西方发达国家职业道德的精华是（ ）。</a></li>
                <li><a href="#">关于“职业精神”的说法中，正确的是（ ）。</a></li>
                <li><a href="#">下列属于比尔•盖茨关于10大优秀员工准则的是（ ）。</a></li>
                <li><a href="#">爱默生说：“诚实的人必须对自己守信，他的最后靠山就是真诚。”下列说法中，符合上述意思的是（ ）。</a></li>
                <li><a href="#">根据禁止商业贿赂行为的暂行规定，下列说法中正确的是（ ）。</a></li>
                <li><a href="#">关于企业管理中的“职业纪律”，正确的说法是（ ）。</a></li>
                <li><a href="#">关于“节约”，正确的理解是（ ）。</a></li>
                <li><a href="#">企业管理人员有效促进合作的途径和方法包括（ ）。</a></li>
                <li><a href="#">所谓拜金主义，其本质是（ ）。</a></li>
                <li><a href="#">作为职业活劫内在的道德准则，“勤勉”的本质要求是（ ）。</a></li>
                <li><a href="#">关于职业化与新型劳动观，正确的说法是（ ）。</a></li>
        ...
        <!-- 1 -->
        <!-- 2 -->
        <div class="zxst_nr" id="divn02" style="display:none;">
            <ul class="ul_zxst_nr">
                <li><a href="#">1（ ）。</a></li>
                <li><a href="#">所谓拜金主义，其本质是（ ）。</a></li>
                <li><a href="#">作为职业活劫内在的道德准则，“勤勉”的本质要求是（ ）。</a></li>
    ...
    <div class="page_right">
        ...
        <!--<span class="span_biaoqian">【标签】</span>-->
        <!--<ul class="ul_biaoqian">-->
            <!--<li><a href="#">普法考试</a></li>-->
            <!--<li><a href="#">两学一做</a></li>-->
            <!--<li><a href="#">三严三实</a></li>-->
            <!--<li><a href="#">中国梦</a></li>-->
