...
<header class="navbar clearfix head">
    <div class="fl logo"><img src="img/123.png" alt=""/></div>
    <div class="fl ct-logo"><h3 style="font-family: Monaco"><span>欢迎使用简单搜题</span></h3></div>
...
<div class="container">
    ...
    <!--<div class="row search">-->
        <!--<input type="text" placeholder="点此输入试题搜索答案" onfocus="this.placeholder=''"-->
               <!--onblur="this.placeholder='点此输入试题搜索答案'"/>-->
        <!--<button>搜索</button>-->
    <!--</div>-->
    <div class="row detailTopic">
        <p class='noVip'>暂无数据</p>
    </div>
